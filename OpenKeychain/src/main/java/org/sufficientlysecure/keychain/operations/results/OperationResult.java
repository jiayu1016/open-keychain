...
public abstract class OperationResult implements Parcelable {
    ...
    public enum LogType {
        ...
        // write secret
        MSG_WS (LogLevel.START, R.string.msg_ws),
        MSG_WS_DB_EXCEPTION (LogLevel.DEBUG, R.string.msg_ws_db_exception),
        MSG_WS_WRITING_SUBKEY_DATA(LogLevel.DEBUG, R.string.msg_ws_writing_subkey_data),
        MSG_WS_SUBKEY_NONEXISTENT (LogLevel.DEBUG, R.string.msg_ws_subkey_nonexistent),
        MSG_WS_SUBKEY_OK (LogLevel.OK, R.string.msg_ws_subkey_ok),
        MSG_WS_SUBKEY_STRIPPED (LogLevel.DEBUG, R.string.msg_ws_subkey_stripped),
        MSG_WS_SUBKEY_DIVERT (LogLevel.DEBUG, R.string.msg_ws_subkey_divert),
        MSG_WS_SUBKEY_EMPTY (LogLevel.DEBUG, R.string.msg_ws_subkey_empty),
        MSG_WS_SUBKEY_PIN (LogLevel.DEBUG, R.string.msg_ws_subkey_pin),
        MSG_WS_SUCCESS (LogLevel.OK, R.string.msg_ws_success),
        MSG_WS_UPDATING_SELF_CERTS (LogLevel.DEBUG, R.string.msg_ws_updating_self_certs),
        MSG_WS_UPDATED_SELF_CERTS (LogLevel.OK, R.string.msg_ws_updated_self_certs),
        ...
        MSG_IS_ERROR_REMOVING_PASSPHRASES(LogLevel.DEBUG, R.string.msg_is_error_removing_passphrases),
        MSG_IS_ERROR_IO_EXC(LogLevel.DEBUG, R.string.msg_is_error_io_exc),
        MSG_IS_ERROR_IO_ENCRYPT(LogLevel.DEBUG, R.string.msg_is_error_io_encrypt),
        ...
        MSG_MF_ERROR_PASSPHRASE_SUBKEY(LogLevel.ERROR, R.string.msg_mf_error_passphrase_subkey),
        ...
        MSG_MF_PASSPHRASE_MISSING(LogLevel.WARN, R.string.msg_mf_missing_passphrase),
        ...
        MSG_CON_DELETE_FOREIGN_PUBLIC(LogLevel.DEBUG, R.string.msg_con_delete_foreign_public),
        MSG_CON_DELETE_OWN_PUBLIC (LogLevel.DEBUG, R.string.msg_con_delete_own_public),
        ...
        MSG_CON_ERROR_IO_FOREIGN_PUBLIC(LogLevel.ERROR, R.string.msg_con_error_io_foreign_public),
        MSG_CON_ERROR_IO_OWN_PUBLIC (LogLevel.ERROR, R.string.msg_con_error_io_own_public),
        MSG_CON_ERROR_IO_SECRET (LogLevel.ERROR, R.string.msg_con_error_io_secret),
        MSG_CON_ERROR_FOREIGN_PUBLIC(LogLevel.ERROR, R.string.msg_con_error_foreign_public),
        MSG_CON_ERROR_OWN_PUBLIC (LogLevel.ERROR, R.string.msg_con_error_own_public),
        ...
        MSG_CON_REIMPORT_FOREIGN_PUBLIC(LogLevel.DEBUG, R.plurals.msg_con_reimport_foreign_public),
        MSG_CON_REIMPORT_OWN_PUBLIC (LogLevel.DEBUG, R.plurals.msg_con_reimport_own_public),
        ...
        MSG_CON_SAVE_FOREIGN_PUBLIC(LogLevel.DEBUG, R.string.msg_con_save_foreign_public),
        MSG_CON_SAVE_SECRET (LogLevel.DEBUG, R.string.msg_con_save_secret),
        MSG_CON_SAVE_OWN_PUBLIC(LogLevel.DEBUG, R.string.msg_con_save_own_public),
        MSG_CON_SUCCESS (LogLevel.OK, R.string.msg_con_success),
        MSG_CON_WARN_DELETE_FOREIGN_PUBLIC(LogLevel.WARN, R.string.msg_con_warn_delete_foreign_public),
        ...
        MSG_CRT_ERROR_DECRYPT_KEYRING(LogLevel.ERROR, R.string.msg_crt_error_decrypt_keyring),
        ...
        MSG_CRT_ERROR_UNLOCK_MASTER(LogLevel.ERROR, R.string.msg_crt_error_unlock_master),
        MSG_CRT_ERROR_UNLOCK_KEYRING(LogLevel.ERROR, R.string.msg_crt_error_unlock_keyring),
        ...
        MSG_WRITE (LogLevel.START, R.plurals.msg_write),
        MSG_WRITE_SUCCESS (LogLevel.OK, R.string.msg_write_success),
